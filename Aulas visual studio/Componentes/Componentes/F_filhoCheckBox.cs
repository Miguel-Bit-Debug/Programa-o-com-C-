...
namespace Componentes
{
    public partial class F_filhoCheckBox : Form
    {
        ...
        {
            cb_carro.Checked = true;
            cb_navio.Checked = true;
            cb_aviao.Checked = true;
            cb_onibus.Checked = true;
        }

        private void btn_desmarcarTodos_Click(object sender, EventArgs e)
        {
            cb_carro.Checked = false;
            cb_navio.Checked = false;
            cb_aviao.Checked = false;
            cb_onibus.Checked = false;
        }
    }
}
